...
This project imports General Transit Feed Specification (GTFS) data from NJTransit into Neo4j and provides web services to interact with the data.
...
This project is largely derived off the work that was done by Rick Van Bruggen:
----
http://blog.bruggen.com/p/about-author.html
----
